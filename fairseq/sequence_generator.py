...
class SequenceGenerator(object):
    def __init__(
        ...
        epsilon=None, num_iter=None, momentum=None
    ):
        ...
        if attack:
            ...
            or momentum is not None, 'target and model required to be not None for attack'
    ...
    def _generate(self, encoder_input, beam_size=None, maxlen=None, prefix_tokens=None, sample_ids=None):
        ...
        for model in self.models:
            ...
            if self.attack:
                ...
                fgsm = FGSMAttack(self.classifier, self.epsilon, self.num_iter, self.momentum)
